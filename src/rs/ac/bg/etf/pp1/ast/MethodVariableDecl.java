...
public class MethodVariableDecl extends MethodVarDecl {

    private MethodVarDecl MethodVarDecl;
    private VarDecl VarDecl;

    public MethodVariableDecl (MethodVarDecl MethodVarDecl, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodVariableDecl(\n");
